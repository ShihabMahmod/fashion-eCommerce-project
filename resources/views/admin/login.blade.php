        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="admin/app-assets/images/logo/robust-logo-dark.png" alt="branding logo"></div>
                </div>
            ...
            <div class="card-footer">
                <div class="">
                    ...
                    <p class="float-sm-right text-xs-center m-0">New to Robust? <a href="/signup" class="card-link">Sign Up</a></p>
                </div>
            </div>
        </div>
    </div>
